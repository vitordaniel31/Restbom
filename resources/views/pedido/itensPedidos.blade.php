        ...
        <div class="row">
          ...
          <tbody>
            ...
            @foreach ($consulta2 as $resultado2)
                ...
                <td>
                  <form action="{{url('/pedidos/excluir', [$resultado2->ped_codigo])}}" method="POST" style="display: inline;">
                      @csrf
                      @method('DELETE')
                  ...
                  <form  action="{{url('/pedidos/atualizar')}}" method="POST" style="display: inline; ">
                      @csrf
                      <input type="hidden" name="id" value="{{$resultado2->ped_codigo}}">
          ...
          <div class="col-lg-6">
            <div class="row justify-content-center">
            <div class="col-md-8 text-center col-sm-12 ">
                <h1 style="display: inline;" data-aos="fade-up">Comanda {{$resultado}}</h1>
                <img height="200px" width="200px"  src="{{url('/qrcode', [$token])}}">
              </div>
            </div>
